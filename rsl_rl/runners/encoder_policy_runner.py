...
from rsl_rl.storage import ContextEstDataset
from rsl_rl.utils import resolve_obs_groups, store_code_state


class EncoderOnPolicyRunner:
    """On-policy runner for training and evaluation of actor-critic methods."""

    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device: str = "cpu", registry_name: str | None = None) -> None:
        self.cfg = train_cfg
